...
PipelineCPU dut(clk,resetn,ia,imem[ia[7:2]],dv,dwe,da,dw,32'd0,rv,rpc,rwe,rd,rwd);
always #5 clk=~clk;
...
initial begin
 ...
 imem[3]=32'hffffffff; // unsupported instruction should report an error
 imem[4]=32'h00700213; // addi x4,x0,7 demonstrates silent continuation
 imem[5]=32'h0000006f;
 #12 resetn=1;
 #400;
 ...
 $display("AFTER_ILLEGAL x4=%0d",dut.regs[4]);
