...
本页记录已经完成的第一轮三类程序、9 组正式结果。第二轮将负载扩展为长无依赖运算流、连续数据依赖、BTFNT 长循环和 32 元素逆序冒泡排序。刘兆钰按 [第二轮执行方案](F3_TEST_PLAN.md) 完成程序改动、12 组 Vivado 测试、复跑检查和材料整理；第一轮结果继续保留，不被第二轮覆盖。
