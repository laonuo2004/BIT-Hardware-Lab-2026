...
M1/M2 主体由刘兆钰交付；左逸龙在 `codex/zuo-m3` 完成基础修复和 M3 接入。结项 F1 扩展后，Vivado 2019.2 功能回归 21/21 通过，板级验证仍待完成。具体版本、日志、波形见 [M3 结果](pipeline/results/m3/README.md)和 [F1 结果](pipeline/results/f1/README.md)，个人报告与答辩素材见[刘兆钰结项材料](刘兆钰-结项材料.md)。原始大三资料继续保留在参考资料目录。
